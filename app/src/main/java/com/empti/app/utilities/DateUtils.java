...
public class DateUtils {
    ...
    public static String formatTime1(long timeInMillis) {
    ...
    public static String formatDate1(long timeInMillis) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MMM-dd HH:mm", Locale.getDefault());
        return dateFormat.format(timeInMillis);
    }

    public static String newdate(long timeInMillis) {
    ...
    public static boolean hasSameDate(long millisFirst, long millisSecond) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
        return dateFormat.format(millisFirst * 1000).equals(dateFormat.format(millisSecond * 1000));
    }

    public static boolean hasSameDate1(long millisFirst, long millisSecond) {
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyyMMdd", Locale.getDefault());
